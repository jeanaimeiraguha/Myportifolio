  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white px-6 py-20">
      <div className="container mx-auto max-w-6xl">
        ...
        <motion.section
          className="py-12 max-w-4xl mx-auto mb-20"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.section
          className="py-20 bg-gray-900 bg-opacity-40 rounded-lg max-w-3xl mx-auto mb-20"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="relative bg-gray-800 shadow-lg rounded-lg p-10 text-gray-300">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-indigo-600">{testimonials[testimonialIndex].role}</p>
              </motion.div>
            </AnimatePresence>
            ...
            <div className="flex justify-between mt-8">
              <button
                ...
                className="text-indigo-600 hover:text-indigo-300 text-3xl font-bold select-none"
              >
                ‹
              </button>
              <button
